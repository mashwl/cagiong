    ...
    <section class="pb-16">
        <div class="container mx-auto">
            <div class="mb-10 flex gap-x-2 text-sm font-semibold">
                <a href="{{ route('home') }}" class="opacity-60">Trang chủ</a>
                <span class="opacity-30">/</span>
                <a href="{{ route('filamentblog.post.all') }}" class="opacity-60">Bài viết</a>
                <span class="opacity-30">/</span>
                ...
                <div class="grid gap-x-20 sm:grid-cols-[minmax(min-content,10%)_1fr_minmax(min-content,10%)]">
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="border-t-2 py-10">
                            <div class="mb-4">
                                <h3 class="mb-2 text-2xl font-semibold">Bình luận</h3>
                            </div>
                ...
                <div>
                    <div class="relative mb-6 flex items-center gap-x-8">
                        <h2 class="whitespace-nowrap text-xl font-semibold">
                            <span class="text-primary font-bold">#</span> Bài viết liên quan
                        </h2>
                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-1 gap-x-12 gap-y-10">
                        ...
                        <div class="col-span-3">
                            <p class="text-center text-xl font-semibold text-gray-300">Không có bài viết nào</p>
                        </div>
                        @endforelse
                    </div>
