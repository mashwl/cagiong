<x-blog-layout>
    @php
        ...
        $formattedPhone = null;
        if ($phone) {
            // Thay 0 đầu thành +84 và thêm dấu cách mỗi 3 số
    ...
    <section x-data="{ tab: 'info', openOrderForm: false, mainImage: '{{ $product->sorted_images->first()?->image_path ?? '' }}' }" class="pb-16" x-cloak>
